...
type Data = { categoryTree: TreeNode<SelectItem>[]; filters: FilterProducts };
...
@Component({
  ...
  template: `
    <div class="flex flex-col justify-center gap-8">
      ...
      <app-filter-products-form [categoryTree]="config.data.categoryTree" [filters]="config.data.filters" />
